...
SAMPLER_CMP(sampler_PointClampCompare);
...
half MainLightRealtimeShadow(float4 shadowCoord)
{
        ...
        return SampleShadowmap(TEXTURE2D_ARGS(_MainLightShadowmapTexture, sampler_PointClampCompare), shadowCoord, shadowSamplingData, shadowParams, false);
    #endif
}
...
half AdditionalLightRealtimeShadow(int lightIndex, float3 positionWS, half3 lightDirection)
{
        ...
        return SampleShadowmap(TEXTURE2D_ARGS(_AdditionalLightsShadowmapTexture, sampler_PointClampCompare), shadowCoord, shadowSamplingData, shadowParams, true);
    #else
        return half(1.0);
    #endif
}
