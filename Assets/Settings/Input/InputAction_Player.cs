...
//     version 1.14.2
//     from Assets/Settings/Input/InputAction_Player.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Settings/Input/InputAction_Player.inputactions".
/// </summary>
/// <remarks>
...
public partial class @InputAction_Player: IInputActionCollection2, IDisposable
{
    ...
    ~@InputAction_Player()
    {
        UnityEngine.Debug.Assert(!m_Touch.enabled, "This will cause a leak and performance issues, InputAction_Player.Touch.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, InputAction_Player.UI.Disable() has not been called.");
    }
    ...
    public struct TouchActions
    {
        ...
        /// </summary>
        public TouchActions(@InputAction_Player wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@InputAction_Player wrapper) { m_Wrapper = wrapper; }
        /// <summary>
