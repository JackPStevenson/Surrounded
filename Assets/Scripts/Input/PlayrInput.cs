...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/_Scripts/PlayerInputScripts/PlayrInput.inputactions".
/// </summary>
/// <remarks>
...
public partial class @PlayrInput: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayrInput()
    {
        UnityEngine.Debug.Assert(!m_Touch.enabled, "This will cause a leak and performance issues, PlayrInput.Touch.Disable() has not been called.");
    }
